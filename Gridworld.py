"""
reference: https://github.com/qqiang00/reinforce/blob/8c7f00d2d4fcace45b7cf5e34e20b61f104afb57/reinforce/gridworld.py
...
class Grid(object):
    def __init__(self, x=None, y=None, type=0, reward=0.0):  # value 属性备用
        self.x = x  # 坐标x
        self.y = y
...
if __name__ == "__main__":
    ...
    for _ in range(20000):
        env.render()
        a = env.action_space.sample()  # sample() is np.random.randint(n)
